...
if __name__ == "__main__":
    ...
    #         inspected_points_quantiles_75.append(np.quantile(inspected_points_error_by_steps[i], 0.75))
    #         inspected_points_quantiles_25.append(np.quantile(inspected_points_error_by_steps[i], 0.25))
    #         uninspected_points_medians.append(np.quantile(uninspected_points_error_by_steps[i], 0.50))
    #         uninspected_points_quantiles_75.append(np.quantile(uninspected_points_error_by_steps[i], 0.75))
    #         uninspected_points_quantiles_25.append(np.quantile(uninspected_points_error_by_steps[i], 0.25))
