...
def load_dataset():
    ...
    ppo1_path = os.path.join(os.path.dirname(__file__), "../data/processed_ppo_dataset1.pkl")
    ppo2_path = os.path.join(os.path.dirname(__file__), "../data/processed_ppo_dataset2.pkl")
